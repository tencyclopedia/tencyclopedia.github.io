' server18.hostingraja.in Secure Email Setup.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "server18.hostingraja.in"		 					' This is the address for the mail server
strOutServerAddress	   = "server18.hostingraja.in"		 					' This is the address for the mail server
...
strAccount			   = "support@tencyclopedia.com"							' Mail account to connect as
